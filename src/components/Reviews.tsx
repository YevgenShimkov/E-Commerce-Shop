...
/**
 * show only if visible containerRef
 */
function ReviewColumn({
  ...
  useEffect(() => {
    ...
    const resizeObserver = new window.ResizeObserver(() => {
      console.log("ResizeObserver works", columnRef.current?.offsetHeight);
      setColumnHeight(columnRef.current?.offsetHeight ?? 0);
    });

    console.log("column ref current: ", columnRef.current);
...
function ReviewGrid() {
  ...
  // amount - how long need to scroll before isInView will be true
